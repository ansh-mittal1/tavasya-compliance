...
$("form-auth").addEventListener("submit", async (e) => {
  ...
  try {
    ...
    err.textContent = e2.message || "Couldn't sign in. Try again.";
    err.hidden = false;
  } finally {
...
$("btn-signout-verify").addEventListener("click", () => signOut(auth));
$("btn-signout-notsetup").addEventListener("click", () => signOut(auth));
