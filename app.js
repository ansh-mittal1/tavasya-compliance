...
const state = { user: null, profile: null, compliances: [], team: [], editingId: null, dashboardScheme: "", dashboardWeekOffset: 0 };
...
function renderDashboard() {
  ...
  // nearest outstanding deadline (within the current scheme filter) drives the distance meter
...
function renderWeeklyPanel() {
  ...
  $("weekly-title").textContent = isCurrent ? "Due this week" : `Week of ${fmtRange(monday, sunday)}`;
